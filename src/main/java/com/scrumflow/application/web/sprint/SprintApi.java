...
public interface SprintApi {
    ...
    SprintResponseDTO updateSprint( @PathVariable Long sprintId, SprintRequestDTO sprintRequestDTO);
    ...
    @GetMapping
    @ResponseStatus(HttpStatus.OK)
    SprintResponseDTO getSprints(@ParameterObject SprintRequestFilterDTO sprintRequestFilterDTO);
